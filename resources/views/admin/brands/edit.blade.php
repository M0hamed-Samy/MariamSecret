            ...
            <div class="wg-box">
                <form action="{{ route('admin.brands.update', ['id' => $brand->id]) }}" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" name="name" placeholder="Brand name"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" name="slug" placeholder="Brand slug"
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview">
                                <img id="preview-img" src="{{ asset('uploads/brands/' . $brand->image) }}" class="effect8"
