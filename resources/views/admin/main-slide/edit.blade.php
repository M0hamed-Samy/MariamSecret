                                ...
                                <span class="error alert-danger text-center">
                                    ...
                                    <fieldset class="name">
                                        ...
                                        <input class="flex-grow" type="text" placeholder="SubTitle" name="subtitle"
                                            tabindex="0" value="{{ $slide->subtitle }}" aria-required="true"
                                            required="">
                                    </fieldset>
                                    @error('subtitle')
                                        <span class="error alert-danger text-center">
                                            ...
                                            <fieldset class="name">
                                                ...
                                                <input class="flex-grow" type="text" placeholder="Link of the product"
                                                    name="link" tabindex="0" value="{{ $slide->link }}"
                                                    ...
                                                    <fieldset class="category">
                                                        ...
                                                        <div class="select flex-grow">
                                                            <select class="" name="status">
                                                                ...
                                                                <option value="1"
                                                                    @if ($slide->status == '1') selected @endif>Active
                                                                </option>
                                                                <option value="0"
                                                                    @if ($slide->status == '0') selected @endif>
                                                                    Inactive</option>
