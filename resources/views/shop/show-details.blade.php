                        ...
                        @foreach ($rproducts as $rproduct)
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.show-details', ['product_slug' => $rproduct->slug]) }}">
                                        <img loading="lazy"
                                            src="{{ asset('uploads/products/' . trim($rproduct->image)) }}"
                                        ...
                                        @if (count($images) > 1 && !empty(trim($images[1])))
                                            <img loading="lazy" src="{{ asset('uploads/products/' . trim($images[1])) }}"
