            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                                    ...
                                    @foreach ($orderItems as $item)
                                        <tr>
                                            ...
                                            <td class="pname">
                                                ...
                                                <div class="name">
                                                    <a href="{{ route('shop.show-details', ['product_slug' => $item->product->slug]) }}"
                    ...
                    @if ($order->status == 'ordered')
                        <div class="wg-box mt-5 text-end"> {{-- Bootstrap 5 prefers `text-end` over `text-right` --}}
                            <form action="{{ route('user.account_cancel_order', ['id' => $order->id]) }}" method="POST"
